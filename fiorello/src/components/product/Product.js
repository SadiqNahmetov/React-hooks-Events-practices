                ...
                <div className="row pt-5">
                    <div className="col-12 d-flex justify-content-between">
                        {/* <ul className="category-mobile d-md-none list-unstyled">
                            <li>
                                <a href="" className="categories mr-2">Categories</a>
                        ...
                        <ul className="list-unstyled">
                            <li>
                                <a href="" className="mr-2">Filter</a>
                                <i className="fas fa-caret-down"></i>
                            </li>
                        </ul>
                    </div>
                ...
                <div className="row">
                    <div className="col-sm-6 col-md-4 col-lg-3 mt-3">
                        <div className="product-item text-center" data-id="popular">
                            <div className="img">
                                ...
                                <img  className="img-fluid" src={require('../../assets/img/shop-14-img.jpg')}/>
                                </a>
                            </div>
                        ...
                        <div className="product-item text-center" data-id="popular">
                            <div className="img">
                                <a href="">
                                    ...
                                    <img  className="img-fluid" src={require('../../assets/img/shop-13-img.jpg')}/>
                                </a>
                            </div>
                            <div className="title mt-3">
                                <h6>MAJESTY PALM</h6>
                        ...
                        <div className="product-item text-center" data-id="winter">
                            <div className="img">
                                <a href="">
                                    ...
                                    <img  className="img-fluid" src={require('../../assets/img/shop-12-img.jpg')}/>
                                </a>
                            </div>
                            <div className="title mt-3">
                                <h6>MAJESTY PALM</h6>
                        ...
                        <div className="product-item text-center" data-id="winter">
                            <div className="img">
                                <a href="">
                                    ...
                                    <img  className="img-fluid" src={require('../../assets/img/shop-11-img.jpg')}/>
                                </a>
                            </div>
                            <div className="title mt-3">
                                <h6>MAJESTY PALM</h6>
                        ...
                        <div className="product-item text-center" data-id="various">
                            <div className="img">
                                <a href="">
                                    ...
                                    <img  className="img-fluid" src={require('../../assets/img/shop-10-img.jpg')}/>
                                </a>
                            </div>
                            <div className="title mt-3">
                                <h6>MAJESTY PALM</h6>
                        ...
                        <div className="product-item text-center" data-id="various">
                            <div className="img">
                                <a href="">
                                    ...
                                    <img  className="img-fluid" src={require('../../assets/img/shop-9-img.jpg')}/>
                                </a>
                            </div>
                            <div className="title mt-3">
                                <h6>MAJESTY PALM</h6>
                        ...
                        <div className="product-item text-center" data-id="exotic">
                            <div className="img">
                                <a href="">
                                    ...
                                    <img  className="img-fluid" src={require('../../assets/img/shop-8-img.jpg')}/>
                                </a>
                            </div>
                            <div className="title mt-3">
                                <h6>MAJESTY PALM</h6>
                    ...
                    <div className="col-sm-6 col-md-4 col-lg-3 mt-3">
                        <div className="product-item text-center" data-id="exotic">
                            <div className="img">
                                <a href="">
                                <img  className="img-fluid" src={require('../../assets/img/shop-7-img.jpg')}/>
                                </a>
                            </div>
                            <div className="title mt-3">
                                <h6>MAJESTY PALM</h6>
